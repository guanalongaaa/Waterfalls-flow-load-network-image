...
- (void)createBrowseView
{
    ...
    _countLabel.frame = CGRectMake((_screenWidth - 70) / 2, _screenHeight - 50, 70, 26);
    _countLabel.layer.masksToBounds = YES;
    _countLabel.layer.cornerRadius = 2.0;
    _countLabel.text = [NSString stringWithFormat:@"%ld/%ld",(long)_currentIndex + 1,(long)_browseItemArray.count];
    _countLabel.shadowOffset = CGSizeMake(0.6, 0.6);
    _countLabel.shadowColor = [UIColor grayColor];
    _countLabel.alpha = 0.3;
...
//            browseCell.zoomScrollView.zoomImageView.frame = rect;
            self.view.alpha = 0;
            browseCell.zoomScrollView.zoomImageView.alpha = 0;
